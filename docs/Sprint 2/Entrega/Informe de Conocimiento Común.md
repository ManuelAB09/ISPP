...
Nuestro equipo ha contribuido con el feedback específico recibido el 12/03/2026 y acciones tomadas. Además, se ha contribuido al feedback general de ambas sesiones de evaluación.

---

## 3. Fortalezas, Debilidades y Acciones Tomadas en el grupo

### Semana 1: Sesión de presentación del 12/03/2026
...
- A la hora de entregar la demo, que se vea bien y sea reporoducible en la propia aplicación desplegada.
- Hacer previsiones y estimaciones de crecimientos de usuarios piloto, y ver si se tienen que tomar medidas.
- Ligar estimaciones de usuarios piloto con las estimaciones de costes y beneficios.
- Decir tecnologías usadas y dar razones.
- Enseñar las desviaciones de tiempo, en sprint actual, y total, por persona.
- Establecer métricas sobre si las soluciones que estamos implementando solucionan los problemas.
- Decir unidades económicas.
- Crear fotos de equipo más homogéneas.
- Diferenciar entre desviación de tiempo, con el rendimiento semanal.
- Incluir detalles de actividades proponemos para hacer team building, ver si sirven con qué frecuencia hacemos las actividades. 
- Incluir más detalle sobre feedback recibido de usuarios piloto y demostrar cómo estamos reaccionando a ese feedback de usuarios piloto.
- Decir qué tipo de precio están dispuesto a pagar los usuarios piloto por nuestros pilotos.
- Listado de usuarios piloto en el entregable de enseñanza virtual, pero no en la presentación.