...
### 1. Seguimiento
Manuel ha pedido que los líderes de cada squad digan cómo van las tareas.
- Backend: Se ha finalizado la versión final de competencia y distinción de ellas, junto al análisis exhaustivo de lo que incluir en el core de la app y lo que no.
- Frontend: Solo los mockups del core (Lider de frontend no asistió y no se encontró trabajo nuevo hecho)
- Arquitectura: Se ha hecho el esbozo de lo que será el ciclo de CI/CD y se ha finalizado el análisis de riesgos. 
...
- Backend: Matriz DAFO.
- Frontend: Mejorar los Mockups e investigar los precios a poner en los planes de la app, e incluirlos en los mockups.
