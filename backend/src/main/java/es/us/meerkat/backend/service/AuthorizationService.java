...
public class AuthorizationService {
    ...
    public boolean isMemberOf(Long userId, Long communityId) {
        return miembroComunidadRepository.findByUsuarioIdAndComunidadId(userId, communityId).isPresent();
    }
    ...
    public MiembroComunidad getMembership(Long userId, Long communityId) {
        return miembroComunidadRepository.findByUsuarioIdAndComunidadId(userId, communityId).orElse(null);
    }

    /**
     * Obtiene el rol como String de un usuario en una comunidad específica.
     * Retorna null si no es miembro.
     */
