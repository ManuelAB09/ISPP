                ...
                .ubicacion(
                        tutor.getUs().getUbicacion() != null
                                ? UbicacionResponse.builder()
                                        .id(tutor.getUs().getUbicacion().getId())
                                        .nombre(tutor.getUs().getUbicacion().getNombre())
                                        .direccion(tutor.getUs().getUbicacion().getDireccion())
                                        .latitud(tutor.getUs().getUbicacion().getLatitud())
                                        .longitud(tutor.getUs().getUbicacion().getLongitud())
                                        .tipo(tutor.getUs().getUbicacion().getTipo())
                                        .coste(tutor.getUs().getUbicacion().getCoste())
                                        .build()
                                : null)
