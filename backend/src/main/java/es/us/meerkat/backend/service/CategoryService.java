...
public class CategoryService {
     ...
     */
    public Categoria createCategory(Long userId, Long communityId, String nombre, String descripcion) {
     ...
     */
    public Categoria updateCategory(Long userId, Long communityId, Long categoryId, String nombre, String descripcion) {
        if (!authorizationService.isAdminOf(userId, communityId)) {
     ...
     */
    public List<Categoria> reorderCategories(Long userId, Long communityId, List<Long> categoryIds) {
        if (!authorizationService.isAdminOf(userId, communityId)) {
        ...
        for (int i = 0; i < categoryIds.size(); i++) {
            ...
            if (!categoria.getComunidad().getId().equals(communityId)) {
                throw new IllegalArgumentException("Una o más categorías no pertenecen a esta comunidad");
            }
