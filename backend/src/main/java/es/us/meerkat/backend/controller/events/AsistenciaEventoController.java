...
/** Controlador para manejar las operaciones relacionadas con la asistencia a eventos. */
@RestController
...
public class AsistenciaEventoController {
    ...
    @GetMapping("/count")
    @Operation(
            summary = "Contar asistentes",
            description = "Devuelve el número total de asistentes confirmados")
