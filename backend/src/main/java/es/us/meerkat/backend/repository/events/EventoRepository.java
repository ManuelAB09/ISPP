 ...
 *
 * <p>
 * Permite realizar operaciones CRUD sobre los eventos en la base de datos, así
 * como consultas
...
public interface EventoRepository extends JpaRepository<Evento, Long> {
        ...
        /**
         * Obtiene todos los eventos visibles en el mapa (solo públicos de comunidades
         * públicas).
         *
         * @return Lista de eventos visibles en mapa.
         */
        @Query("SELECT e FROM Evento e WHERE e.visibleMapa = true AND e.cancelado = false AND"
         ...
         */
        @Query("SELECT e FROM Evento e WHERE e.privado = false AND e.cancelado = false AND e.fechaHora"
                        + " >= :ahora")
        ...
        /**
         * Obtiene todos los eventos activos de las comunidades a las que pertenece el
         * usuario: eventos
         * futuros, eventos en curso (fechaFin no ha pasado) y eventos sin fecha de fin
         * que empezaron
         * hace menos de 2 horas. Ordena por fecha ascendente.
         *
         * @param usuarioId    Identificador del usuario.
         * @param ahora        Momento actual.
         * @param limiteMargen Momento actual menos el margen (ahora - 2h) para eventos
         *                     sin fechaFin.
        ...
        /**
         * Obtiene todos los eventos (pasados y futuros) de las comunidades del usuario.
         * Incluye
        ...
        /**
         * Obtiene eventos próximos de un usuario en un rango de tiempo específico.
         * Usado por el
        ...
        /**
         * Obtiene todos los eventos que están en un rango de tiempo (para el scheduler
         * global). No
        ...
        /**
         * Obtiene eventos a los que el usuario ha confirmado asistencia y están
         * próximos o en curso.
         *
         * @param usuarioId Identificador del usuario.
         * @param ahora     Momento actual.
        ...
        /**
         * Obtiene todos los eventos cuya fecha de fin (o fechaHora si no tiene fin) es
         * anterior a la
        ...
        /**
         * Obtiene solo los eventos cancelados de una comunidad (sin límite de fecha).
         * Usado cuando el usuario activa el checkbox "Mostrar cancelados".
         *
         * @param comunidadId Identificador de la comunidad.
