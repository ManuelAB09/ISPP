        ...
        try {
            ...
            switch (tipo) {
                case SUSCRIPCION -> {
                    ...
                    es.us.meerkat.backend.entity.subscriptions.TipoPlan plan =
                            "PRO".equalsIgnoreCase(planMeta)
                                    ? es.us.meerkat.backend.entity.subscriptions.TipoPlan.PRO
                                    : es.us.meerkat.backend.entity.subscriptions.TipoPlan.PREMIUM;
                        ...
                        es.us.meerkat.backend.entity.subscriptions.TipoPlanCorporativo
                                tipoPlanCorporativo =
                                        tipoPlanCorporativoStr != null
                                                ? es.us.meerkat.backend.entity.subscriptions
