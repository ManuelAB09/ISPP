 ...
 *
 * <p>
 * Se ejecuta únicamente con el perfil por defecto (H2 en memoria). No se activa
 * en los perfiles
...
public class DataSeeder {
        ...
        CommandLineRunner seedDatabase(
                ...
                return args -> {
                        ...
                        Apunte ap1 = Apunte.builder()
                                        .titulo("Tema 1: Introducción a Spring Boot")
                                        .descripcion("Apuntes completos sobre los fundamentos de Spring Boot y creación de proyectos")
                        ...
                        Apunte ap2 = Apunte.builder()
                                        .titulo("Tema 2: Componentes de React")
                                        .descripcion("Ejemplos prácticos y mejores prácticas sobre componentes funcionales en React")
                                        .contenido(contenidoPDF)
                        ...
                        Apunte ap3 = Apunte.builder()
                                        .titulo("Introducción a Machine Learning")
                                        .descripcion("Conceptos fundamentales del machine learning con scikit-learn y numpy")
                                        .contenido(contenidoPDF)
                        ...
                        Apunte ap4 = Apunte.builder()
                                        .titulo("Álgebra Lineal - Matrices y Determinantes")
                                        .descripcion("Ejercicios resueltos sobre matrices, determinantes y sistemas de ecuaciones")
                                        .contenido(contenidoPDF)
                        ...
                        Apunte ap5 = Apunte.builder()
                                        .titulo("Fundamentos de ISPP")
                                        .descripcion("Resumen de conceptos clave para la asignatura de Ingeniería del Software")
                                        .contenido(contenidoPDF)
