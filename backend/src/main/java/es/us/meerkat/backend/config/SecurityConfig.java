 ...
 *
 * <p>
 * Define política JWT sin estado, rutas públicas y el bean de cifrado de
 * contraseñas.
 */
@Configuration
public class SecurityConfig {
         ...
         *
         * <p>
         * El filtro JWT se inyecta como parámetro del método para evitar dependencias
         * circulares en
         * el contexto.
         *
        ...
        /**
         * Evita que Spring Boot registre el filtro JWT dos veces (una como servlet
         * filter y otra dentro
         * de Spring Security).
         *
