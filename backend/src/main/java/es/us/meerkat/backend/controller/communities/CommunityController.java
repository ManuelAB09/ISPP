...
import es.us.meerkat.backend.dto.users.RequestListResponse;
...
/**
 * Controlador REST para la gestión de comunidades de estudio. Implementa todos
 * los endpoints
 * relacionados con comunidades definidos en el OpenAPI. Base URL:
 * /api/v1/communities
 */
@RestController
...
public class CommunityController {
    ...
    /**
     * Lista las comunidades públicas con filtros opcionales. GET
     * /api/v1/communities
     */
    @GetMapping
    ...
    public ResponseEntity<CommunityListResponse> listCommunities(
        ...
        Page<Comunidad> comunidades = communityService.listActiveCommunities(
                search, categoria, institucion, tipoGrupo, tipoPlan, pageable);
        Page<CommunityDetailResponse> response = comunidades.map(c -> entityToDetailResponse(c, userId));
    ...
    public ResponseEntity<List<CategoryResponse>> listCategories() {
        List<CategoryResponse> response = categoryService.listAvailableCategories().stream()
    ...
    public ResponseEntity<CommunityListResponse> listMyCommunities(
        ...
        Page<CommunityDetailResponse> response = memberships.map(
                membership -> entityToDetailResponse(membership.getComunidad(), usuario.getId()));
    ...
    @PostMapping
    @Operation(summary = "Crear comunidad", description = "Crea una nueva comunidad. El creador se convierte"
            + " automáticamente en administrador.", security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "Comunidad creada correctamente"),
            @ApiResponse(responseCode = "400", description = "Datos inválidos o límite de comunidades gratuitas"
                    + " alcanzado"),
            @ApiResponse(responseCode = "401", description = "Usuario no autenticado")
    })
            ...
            Comunidad comunidad = communityService.createCommunity(
                    ...
                    request.tipoGrupo() != null
                            ? es.us.meerkat.backend.entity.communities.TipoGrupo.valueOf(
                                    request.tipoGrupo())
                            : es.us.meerkat.backend.entity.communities.TipoGrupo.COMUNIDAD_PUBLICA,
                    request.imagenUrl(),
    ...
    @Operation(summary = "Obtener detalle de comunidad", description = "Devuelve los detalles completos de una comunidad")
    @ApiResponses({
    ...
    @Operation(summary = "Actualizar comunidad", description = "Actualiza los datos de la comunidad (solo admin)", security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses({
    ...
    public ResponseEntity<CommunityDetailResponse> updateCommunity(
        ...
        Comunidad comunidad = communityService.updateCommunity(
                usuario.getId(),
                communityId,
                request.nombre(),
                request.descripcion(),
    ...
    /**
     * Actualiza la privacidad de una comunidad. PUT
    ...
    public ResponseEntity<CommunityDetailResponse> updateCommunityPrivacy(
        ...
        Comunidad comunidad = communityService.updatePrivacy(
                usuario.getId(),
                communityId,
                es.us.meerkat.backend.entity.communities.TipoGrupo.valueOf(
                        request.tipoGrupo()));
    ...
    /**
     * Mejora una comunidad a Premium. POST
    ...
    /**
     * Contrata un tutor para la comunidad. POST
    ...
    @Operation(summary = "Subir foto de comunidad", description = "Sube una imagen para la portada de la comunidad (solo admin)", security = @SecurityRequirement(name = "bearerAuth"))
    public ResponseEntity<CommunityDetailResponse> uploadCommunityPhoto(
        ...
        try {
            Comunidad comunidad = communityService.actualizarFotoComunidad(usuario.getId(), communityId, file);
            return ResponseEntity.ok(entityToDetailResponse(comunidad, usuario.getId()));
        } catch (IllegalArgumentException e) {
            return ResponseEntity.badRequest().build();
        } catch (Exception e) {
    ...
    /**
     * Lista los miembros de una comunidad. GET
     * /api/v1/communities/{communityId}/members
     */
    @GetMapping("/{communityId}/members")
    @Operation(summary = "Listar miembros", description = "Devuelve la lista de miembros de la comunidad")
    ...
    /**
     * Se une a una comunidad pública. POST
     * /api/v1/communities/{communityId}/members
     */
    ...
    public ResponseEntity<?> joinPublicCommunity(
        ...
        try {
            ...
            MiembroComunidad miembro = memberService.joinPublicCommunity(usuario.getId(), communityId, desiredRol);
    ...
    @Operation(summary = "Expulsar miembro", description = "Expulsa a un miembro de la comunidad (solo admin)", security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses({
    ...
    public ResponseEntity<MemberResponse> transferAdmin(
        ...
        try {
            ...
            MiembroComunidad newAdmin = memberService.transferAdmin(
    ...
    @Operation(summary = "Promover miembro a admin", description = "Asciende a ADMIN a un miembro existente (solo admin actual)", security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses({
    ...
    public ResponseEntity<MemberResponse> promoteMemberToAdmin(
        ...
        try {
            MiembroComunidad promotedMember = memberService.promoteToAdmin(usuario.getId(), communityId, userId);
    ...
    /**
     * Ranking de miembros por actividad. GET
     * /api/v1/communities/{communityId}/ranking
     */
    @GetMapping("/{communityId}/ranking")
    @Operation(summary = "Ranking de miembros", description = "Devuelve el ranking de actividad de los miembros de la comunidad", security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses({
    ...
    /**
     * Añade un nuevo administrador a la comunidad (solo comunidades corporativas).
     * POST
     * /api/v1/communities/{communityId}/admins
     */
    @PostMapping("/{communityId}/admins/{nuevoAdminId}")
    @Operation(summary = "Añadir administrador (corporativo)", description = "Añade un administrador adicional a una comunidad corporativa", security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses({
    ...
    public ResponseEntity<?> addAdminToCommunity(
        ...
        try {
            MiembroComunidad miembro = memberService.addAdmin(usuario.getId(), communityId, nuevoAdminId);
            return ResponseEntity.ok(entityToMemberResponse(miembro));
        } catch (IllegalArgumentException e) {
            return ResponseEntity.badRequest()
                    .body(MessageResponse.builder().message(e.getMessage()).build());
    ...
    /**
     * Solicita acceso a una comunidad privada. POST
     * /api/v1/communities/{communityId}/requests
     */
    ...
    @Operation(summary = "Comprobar mi solicitud pendiente", description = "Devuelve si el usuario autenticado tiene una solicitud pendiente en esta"
    ...
    public ResponseEntity<RequestResponse> respondToRequest(
        ...
        try {
            SolicitudComunidad solicitud = requestService.respondToRequest(
    ...
    /**
     * Lista las categorías de una comunidad. GET
     * /api/v1/communities/{communityId}/categories
     */
    @GetMapping("/{communityId}/categories")
    @Operation(summary = "Listar categorías", description = "Devuelve las categorías temáticas de la comunidad")
    ...
    @Operation(summary = "Crear categoría", description = "Crea una nueva categoría temática (solo admin)", security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses({
    ...
    public ResponseEntity<CategoryResponse> createCategory(
        ...
        Categoria categoria = categoryService.createCategory(
    ...
    /**
     * Actualiza una categoría. PUT
     * /api/v1/communities/{communityId}/categories/{categoryId}
     */
    @PutMapping("/{communityId}/categories/{categoryId}")
    @Operation(summary = "Actualizar categoría", description = "Actualiza los datos de una categoría (solo admin)", security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses({
    ...
    public ResponseEntity<CategoryResponse> updateCategory(
        ...
        try {
            Categoria categoria = categoryService.updateCategory(
                    usuario.getId(),
                    communityId,
                    categoryId,
                    request.nombre(),
    ...
    @Operation(summary = "Eliminar categoría", description = "Elimina una categoría (solo admin)", security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses({
    ...
    @Operation(summary = "Reordenar categorías", description = "Cambia el orden de las categorías (solo admin)", security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses({
    ...
    /**
     * Crea un nuevo evento en una comunidad. POST
     * /api/v1/communities/{communityId}/events
     */
    @PostMapping("/{communityId}/events")
    @Operation(summary = "Crear evento en comunidad", description = "Crea un nuevo evento asociado a una comunidad", security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses({
    ...
    /**
     * Lista los eventos de una comunidad. GET
     * /api/v1/communities/{communityId}/events
     */
    @GetMapping("/{communityId}/events")
    @Operation(summary = "Listar eventos de comunidad", description = "Devuelve los eventos asociados a una comunidad")
    @ApiResponses({
    ...
    public ResponseEntity<List<EventSummaryResponse>> listCommunityEvents(
        ...
        List<EventSummaryResponse> response = eventos.stream().map(Evento::toSummaryDTO).collect(Collectors.toList());
    ...
    /**
     * Vincula un curso de Google Classroom a una comunidad. POST
     * /api/v1/communities/{id}/classroom
     */
    @PostMapping("/{communityId}/classroom")
    @Operation(summary = "Vincular curso de Google Classroom", description = "Vincula un curso de Google Classroom a la comunidad. Solo el admin puede"
            + " hacerlo.", security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses({
    ...
    public ResponseEntity<ClassroomInfoResponse> linkClassroom(
        ...
        try {
            ComunidadClassroom cc = googleClassroomService.vincularCurso(
    ...
    /**
     * Desvincula el curso de Google Classroom de una comunidad. DELETE
     * /api/v1/communities/{id}/classroom
     */
    @DeleteMapping("/{communityId}/classroom")
    @Operation(summary = "Desvincular curso de Google Classroom", description = "Elimina la vinculación con Google Classroom. Solo el admin puede hacerlo.", security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses({
    ...
    @Operation(summary = "Obtener curso vinculado", description = "Devuelve la información del curso de Google Classroom vinculado a la"
            + " comunidad")
    @ApiResponses({
    ...
    private CommunityDetailResponse entityToDetailResponse(Comunidad comunidad, Long userId) {
        ...
        if (userId != null) {
            es.us.meerkat.backend.entity.communities.MiembroComunidad membership = authorizationService
                    .getMembership(userId, comunidad.getId());
            if (membership != null) {
                miRol = membership.getRol().name();
                miRolDocente = membership.getRolDocente() != null
        ...
        ClassroomInfoResponse classroomInfo = googleClassroomService
                .getVinculacion(comunidad.getId())
                .map(
                        cc -> new ClassroomInfoResponse(
                                cc.getId(),
                                cc.getClassroomCourseId(),
                                cc.getClassroomCourseName(),
                                cc.getActiva()))
    ...
    /**
     * Contrata un tutor para la comunidad. Inicializa el pago y retorna URL de
     * pago.
     *
     * <p>
    ...
    @Operation(summary = "Contratar tutor", description = "Contrata un tutor para la comunidad. Retorna URL de pago.", security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Tutor contratación iniciada, URL de pago generada"),
            @ApiResponse(responseCode = "400", description = "Datos inválidos o validación fallida"),
            @ApiResponse(responseCode = "401", description = "Usuario no autenticado"),
            @ApiResponse(responseCode = "403", description = "No tienes permisos para contratar en esta comunidad"),
    ...
    public ResponseEntity<PaymentUrlResponse> hireTutor(
        ...
        try {
            PaymentUrlResponse paymentUrl = tutorContratacionService.crearContratacion(
    ...
    @Operation(summary = "Crear PaymentIntent para contratación de tutor", description = "Devuelve clientSecret para usar con Stripe Elements embebido", security = @SecurityRequirement(name = "bearerAuth"))
    public ResponseEntity<?> crearHiringPaymentIntent(
        ...
        try {
            java.util.Map<String, String> result = paymentService.crearPaymentIntentContratacionTutor(
                    tutorId,
                    communityId,
    ...
    @Operation(summary = "Confirmar pago de contratación de tutor", description = "Verifica el PaymentIntent y activa la contratación", security = @SecurityRequirement(name = "bearerAuth"))
    public ResponseEntity<?> confirmarPagoContratacion(
        ...
        try {
            ...
            java.math.BigDecimal monto = java.math.BigDecimal.valueOf(intent.getAmount())
    ...
    @Operation(summary = "Cancelar tutor", description = "Cancela la contratación del tutor activo de la comunidad.", security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses({
    ...
    public ResponseEntity<?> cancelarTutor(
        ...
        try {
            var contratacion = tutorContratacionService.obtenerContratacionActivaDeComunidad(communityId);
    ...
    @Operation(summary = "Obtener tutor activo", description = "Obtiene el tutor actualmente contratado por la comunidad")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Tutor encontrado"),
            @ApiResponse(responseCode = "404", description = "Comunidad no encontrada o sin tutor activo")
    })
