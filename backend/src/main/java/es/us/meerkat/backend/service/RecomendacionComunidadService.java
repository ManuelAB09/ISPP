...
public class RecomendacionComunidadService {
    ...
    public RecomendacionResponse toResponse(RecomendacionComunidad recomendacion) {
        ...
        return new RecomendacionResponse(
                recomendacion.getId(),
                recomendacion.getComunidad().getId(),
                recomendacion.getComunidad().getNombre(),
                recomendacion.getComunidad().getDescripcion(),
                recomendacion.getComunidad().getImagenUrl(),
                recomendacion.getFactor(),
                Math.round(recomendacion.getRelevancia() * 100.0) / 100.0,
                motivo);
    }
