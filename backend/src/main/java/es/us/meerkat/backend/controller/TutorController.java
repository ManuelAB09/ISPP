...
public class TutorController {
                                ...
                                .ubicacion(
                                                tutor.getUsuario() != null && tutor.getUsuario().getUbicacion() != null
                                                                ? UbicacionResponse.builder()
                                                                                .id(tutor.getUsuario().getUbicacion()
                                                                                                .getId())
                                                                                .nombre(tutor.getUsuario()
                                                                                                .getUbicacion()
                                                                                                .getNombre())
                                                                                .direccion(tutor.getUsuario()
                                                                                                .getUbicacion()
                                                                                                .getDireccion())
                                                                                .latitud(tutor.getUsuario()
                                                                                                .getUbicacion()
                                                                                                .getLatitud())
                                                                                .longitud(tutor.getUsuario()
                                                                                                .getUbicacion()
                                                                                                .getLongitud())
                                                                                .tipo(tutor.getUsuario().getUbicacion()
                                                                                                .getTipo())
                                                                                .coste(tutor.getUsuario().getUbicacion()
                                                                                                .getCoste())
                                                                                .build()
                                                                : null)
                                .build();
        ...
        @Operation(summary = "Verificar sesión de pago de verificación", description = "Confirma el pago de verificación del tutor usando el sessionId de Stripe")
        public ResponseEntity<?> verificarSesionVerificacion(
                ...
                try {
                        ...
                        BigDecimal monto = session.getAmountTotal() != null
