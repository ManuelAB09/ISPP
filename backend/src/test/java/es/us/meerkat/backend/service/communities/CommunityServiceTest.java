...
class CommunityServiceTest {
        ...
        void createCommunityShouldCreateFreeCommunityAndAssignAdmin() {
                ...
                ArgumentCaptor<MiembroComunidad> memberCaptor = ArgumentCaptor.forClass(MiembroComunidad.class);
        ...
        void updatePrivacyShouldPersistNewTypeWhenUserIsAdmin() {
                Comunidad comunidad = buildComunidad(10L, TipoGrupo.COMUNIDAD_PUBLICA, TipoPlanComunidad.FREE);
        ...
        void listActiveCommunitiesShouldUseSearchFilterWhenSearchProvided() {
                ...
                communityService.listActiveCommunities("java", null, null, null, null, PageRequest.of(0, 20));
        ...
        void createCommunityShouldSetRolDocenteWhenRolInicialProfesor() {
                ...
                MiembroComunidad savedMembership = MiembroComunidad.builder().id(50L).usuario(usuario)
                                .rol(RolComunidad.ADMIN).build();
        ...
        void updateCommunityShouldUpdateFields() {
                ...
                Comunidad result = communityService.updateCommunity(1L, 10L, "Nuevo nombre", "Nueva desc", "img.png");
        ...
        void upgradeToPremiumShouldThrowWhenAlreadyPremium() {
                Comunidad comunidad = buildComunidad(10L, TipoGrupo.COMUNIDAD_PUBLICA, TipoPlanComunidad.PREMIUM);
                when(authorizationService.isAdminOf(1L, 10L)).thenReturn(true);
                when(comunidadRepository.findById(10L)).thenReturn(Optional.of(comunidad));
        ...
        void createCommunityShouldSetPremiumPlanForPremiumUser() {
                ...
                Comunidad result = communityService.createCommunity(
        ...
        void listActiveCommunitiesShouldSearchByName() {
                ...
                communityService.listActiveCommunities("java", null, null, null, null, PageRequest.of(0, 10));
