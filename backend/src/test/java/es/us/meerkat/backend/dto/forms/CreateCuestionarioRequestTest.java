...
class CreateCuestionarioRequestTest {
    ...
    @BeforeEach
    void setUp() {
        request = CreateCuestionarioRequest.builder()
            .titulo("Test Quiz")
            .materia("Matemáticas")
    ...
    void testDecimalTimeNotAllowed() {
        ...
        CreateCuestionarioRequest requestWithDecimal = CreateCuestionarioRequest.builder()
            .titulo("Test Quiz")
            .materia("Matemáticas")
    ...
    void testNegativeTimeNotAllowed() {
        CreateCuestionarioRequest requestWithNegative = CreateCuestionarioRequest.builder()
            .titulo("Test Quiz")
            .materia("Matemáticas")
    ...
    void testZeroTimeNotAllowed() {
        CreateCuestionarioRequest requestWithZero = CreateCuestionarioRequest.builder()
            .titulo("Test Quiz")
            .materia("Matemáticas")
    ...
    void testValid1Minute() {
        CreateCuestionarioRequest validRequest = CreateCuestionarioRequest.builder()
            .titulo("Test Quiz")
            .materia("Matemáticas")
    ...
    void testExceedsMaxTime() {
        CreateCuestionarioRequest requestWithExcessTime = CreateCuestionarioRequest.builder()
            .titulo("Test Quiz")
            .materia("Matemáticas")
