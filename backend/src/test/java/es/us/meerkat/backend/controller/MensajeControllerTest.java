...
class MensajeControllerTest {
        ...
        void enviarMensaje_ok() {
                ...
                EnviarMensajeRequest req = new EnviarMensajeRequest(); req.setUserId(2L); req.setContenido("Hola");
        ...
        void editarMensaje_ok() {
                ...
                ResponseEntity<?> r = controller.editarMensaje(u, 5L, new EnviarMensajeRequest() {{ setContenido("Editado"); }});
        ...
        void enviarArchivo_ok() {
                ...
                var vf = new ChatFileStorageService.ValidatedChatFile("contenido".getBytes(), "test.txt", "text/plain", 8L);
                ...
                when(mensajeService.enviarArchivo(1L, 2L, null, null, vf.originalName(), vf.mimeType(), vf.sizeBytes(), vf.content())).thenReturn(resp);
